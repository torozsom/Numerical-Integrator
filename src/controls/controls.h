/**
 * @file controls.h
 * @brief Header file for the controls module, which includes function declarations for
 *        validating input, performing numerical integration, and managing resources.
 *
 * This module is part of a numerical integration program that allows users to compute
 * integrals using various methods and manage input/output operations.
 */
